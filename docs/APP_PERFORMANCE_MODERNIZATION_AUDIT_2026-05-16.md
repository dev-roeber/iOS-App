...
- **Nachteile:** 28 iOS-17-Availability-Gates + 9 iOS-16.2-Gates bleiben als kognitive Last und Code-Komplexität. `Map(coordinateRegion:)` als deprecated Pfad lebt weiter, falls noch genutzt. `@Observable` aus iOS 17 (Observation-Framework) bleibt unzugänglich.
