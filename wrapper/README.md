...
- `swift test` im aktiven Repo `iOS-App` lief lokal grün mit `991` Tests, `2` Skips und `0` Failures (Stand 2026-05-06, HEAD post-`70254ff` nach Memory-Safety-Folgefix; Auto-Restore lehnt rohe Google-Timeline-Dateien jetzt unabhängig von der Größe ab — Sniffer-Skip zusätzlich zum 50-MB-Cap; manuelle Importe bleiben unberührt; vorher 987 nach erstem Memory-Safety-Fix, 973 nach LH2GPXLoadingBackground, 964 nach Doku-/Wiring-Audit-Polish, 949 am 2026-05-06 09:57)
