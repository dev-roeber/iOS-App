...
- [ ] Historien-Track-Editor: Mutations-Reset beim Import-Wechsel — Deletions persistieren in UserDefaults über Datei-Wechsel hinaus, wenn dayKeys übereinstimmen; `AppImportedPathMutationStore.reset()` existiert, aber kein UI-Trigger und kein Auto-Reset beim Import
