...
- [ ] **46-MB-Crashfall (Großimport echtes iPhone)** — Status **FAILED** (reproduziert 2026-05-07 auf iPhone 15 Pro Max, iOS 26.4); Code-Fix in `GoogleTimelineStreamReader` (autoreleasepool umschließt Parse + Ingest; Element-Capacity-Reset nach Outliern); **Hardware-Retest mit der originalen 46-MB-ZIP steht aus**, bleibt FAILED bis Tester ihn grün bestätigt. Siehe Sektion 1 in `docs/APPLE_VERIFICATION_CHECKLIST.md` (Manual Release Risk Acceptance Protocol)
