...
- [ ] **Distribution-Zertifikat / ASC-Upload-Pfad lokal vervollstaendigen** — aktueller Host kann das Archive nur mit `Apple Development` signieren; `xcodebuild -exportArchive` scheitert repo-wahr mit `No signing certificate "iOS Distribution" found`, `altool` zusaetzlich ohne konfigurierte ASC-Authentifizierung
