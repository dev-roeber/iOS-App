...
- [ ] **Performance-Smoke-Test mit echten/großen Datenmengen abschließen** — App mit realer Location-History-Datei (>20 MB) auf echtem iPhone testen; UI-Hänger nach Screen/Flow erfassen; nur reproduzierbare oder >2–3 Sekunden lange Hänger als Bug priorisieren (Build 1.0 (44): gelegentliche UI-Ruckler beobachtet, kein bestätigter Crash)
