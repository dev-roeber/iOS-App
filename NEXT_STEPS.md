...
- [ ] **46-MB-Crashfall (Großimport echtes iPhone)** — siehe Sektion 1 in `docs/APPLE_VERIFICATION_CHECKLIST.md` (Manual Release Risk Acceptance Protocol)
