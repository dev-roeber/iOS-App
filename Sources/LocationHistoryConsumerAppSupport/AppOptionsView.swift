                    ...
                    Button(role: .destructive) {
                        ...
                        HStack(spacing: 6) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                Text(t("Technische Diagnose: Entitlement/Profile prüfen, im Apple Developer Portal App Services und App Capabilities für WeatherKit aktivieren, danach Profil aktualisieren und App neu installieren."))
                                    .font(.caption2)
                                    .foregroundStyle(.secondary)
                                    .fixedSize(horizontal: false, vertical: true)
